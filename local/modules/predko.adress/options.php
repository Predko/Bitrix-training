...
$module_id = 'predko.adress'; //обязательно, иначе права доступа не работают!
...
$aTabs = array(
    array(
        'DIV' => 'edit1',
        'TAB' => Loc::getMessage('PREDKO_ADRESS_TAB_SETTINGS'),
        'OPTIONS' => array(
            array('field_text', Loc::getMessage('PREDKO_ADRESS_FIELD_TEXT_TITLE'),
                '',
                array('textarea', 10, 50)),
            array('field_line', Loc::getMessage('PREDKO_ADRESS_FIELD_LINE_TITLE'),
                '',
                array('text', 10)),
            array('field_list', Loc::getMessage('PREDKO_ADRESS_FIELD_LIST_TITLE'),
                '',
...
<form method='post' action='<?echo $APPLICATION->GetCurPage()?>
    ?mid=<?=htmlspecialcharsbx($request['mid'])?>&amp;lang=<?=$request['lang']?>' name='predko_adress_settings'>
